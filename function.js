...
document.addEventListener("DOMContentLoaded", function () {
    function appendSearchIcon() {
        ...
        searchIconSpan.innerHTML = `
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 256 256" style="max-width:20px;max-height:20px;transform: translateX(-25px);">
