...
document.addEventListener("DOMContentLoaded", function () {
    function appendSearchIcon(inputContainer) {
        ...
        const searchInput = inputContainer.querySelector('.select2-search__field');
        if (searchInput) {
    ...
    $(document).ready(function() {
        ...
        $('#secteur').on('select2:open', function() {
            const secteurContainer = document.querySelector('#secteur + span');
            appendSearchIcon(secteurContainer);
        });
    
        $('#activite').on('select2:open', function() {
            const activiteContainer = document.querySelector('#activite + span');
            appendSearchIcon(activiteContainer);
        });
    });
