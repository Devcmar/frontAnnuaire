...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (searchInput && annonceInput) {
      ...
      // Insert the icon after searchInput
      searchInput.parentNode.insertBefore(searchIconCity, searchInput.nextSibling);
  
      // Clone the icon for insertion after annonceInput
      const searchIconCityClone = searchIconCity.cloneNode(true);
      annonceInput.parentNode.insertBefore(searchIconCityClone, annonceInput.nextSibling);
    }
});
